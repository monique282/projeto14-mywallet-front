  ...
  return (
    <SingInContainer>
      <form onSubmit={login}>
        ...
        <input placeholder="" type="password" autoComplete="new-password" required value={password} onChange={(e) => setSenha(e.target.value)} disabled={disabled} data-test="password" />
